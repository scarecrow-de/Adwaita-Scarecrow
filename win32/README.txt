...
please check whether there are any 0-size files in Adwaita-Scarecrow/scalable and/or
Adwaita-Scarecrow/cursors.  If there are, there is a good chance that you are affected by
...
the installed icons, simply delete the $(PREFIX)\share\icons\Adwaita-Scarecrow folder.
